...
var full_url ="";
var _product_id = "";
function RateIt(box_mode,restrict_type,product_id,rate_id,clicked,website,pageX,pageY,lang,error_msg)
{            
     ...
     {                   
         ...
         if(parseInt(box_mode)==1) ShowLoginBox(rate_id,product_id,pageX,pageY,lang);         
         else PostData(rate_id,product_id);
