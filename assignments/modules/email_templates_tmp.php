	...
	<table>
		...
		<tr>
			<td align=center>
                ...
                <?php if(access::has("edit_mail_templates")) { ?>
		<tr>	
			<td align=center>
				<input class="btn green" onclick="save_template()" style="width:135px" type=button id=btnSave name=btnSave value="<?php echo SAVE ?>" />
				<input class="btn green
				" style="width:135px" type=button id=btnCancel name=btnCancel value="<?php echo CANCEL ?>" />
			</td>
		</tr>	
                <?php } ?>
	</table>
