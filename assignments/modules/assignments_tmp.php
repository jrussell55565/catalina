...
<table style="width:100%"><tr><td>
   <table  border="0" cellpadding="3" align="right" style="display:<?php echo $hide_mobile ?>">
                    <tr>                   
                        <?php if(access::has("asg_change_brn")) { ?>
                        <td >
                                <select class="form-control input-inline input-medium" onchange="ChangeBranch()" id="btnChangeBrn" name="btnChangeBrn"><option value="-1" ><?php echo CHANGE_BRANCH ?></option><?php echo $branch_options ?></select> 
                        </td>
                        <?php } ?>
                        <?php if(access::has("asg_copy_struct-")) { ?>
                        <td valign="top">
                                &nbsp;<input class="btn green" onclick="ProcessCommand('create_copy')" type="button" value="<?php echo COPY_STRUCTURE ?>" id="btnCopy" name="btnCopy" class="btn" /> 
                        </td>
                        <?php } ?>
                        <?php if(access::has("delete_assignment")) { ?>
                        <td valign="top">
...
<form id="form1" name="form1">
 <div id="div_grid"><?php echo $grid_html ?></div>
    ...
    <a class="btn btn-primary" href="?module=add_assignment"><?php echo NEW_ASSIGNMENT ?></a>
