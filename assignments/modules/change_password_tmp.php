...
<table style="display:<?php echo $pass_display ?>">
	<tr>
		...
		<td>
			<input class='form-control' type="text" id=txtOldPass name=txtOldPass maxlength=20  />  
		</td>
	</tr>
	<tr>
		<td class="desc_text">
		...
		<td>
			<input class='form-control' type="text" id=txtNewPass name=txtNewPass maxlength=20  /> 
		</td>
	</tr>
	<tr>
		<td colspan=2 align=center><br />
			<input type=button class="btn green" id=btnSave name=btnSave value="<?php echo SAVE ?>" onclick="checkform()" style="width:125px" />
			<input type=button class="btn green" id=btnCancel name=btnCancel value="<?php echo CANCEL ?>" onclick="javascript:history.back(1)" style="width:125px" />
		</td>	
	</tr>
</table>
