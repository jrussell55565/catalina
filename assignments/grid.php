<?php
    ...
    class grid
    {
        ...
        var $table = "<table border=1 class=\"table table-striped table-bordered mediaTable\" id='table-3'>";
        var $edit = true;
        var $edit_attr="";        
        var $delete = true;
        var $edit_text = EDIT;
        ...
        public static function ProcessCommandTemplate($row,$value,$key,$grd,$confirm="")
        {
            $html = "<td>&nbsp;<a href='javascript:jsProcessCommand(".$row[$grd->id_column].", \"$grd->page_name\", \"$grd->grid_control_name\", \"$value\",\"$confirm\" )'>$key</a></td>";
            return $html;
        }
