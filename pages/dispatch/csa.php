          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table width="464" border="1">
                  <tr>
                    <td width="454" colspan="3">Data To display from Import CSA File</td>
                  </tr>
            </table>
              <p>&nbsp;</p>
            ...
            <div class="box-body">
              <form name="form1" method="post" action="">
                <table width="311" height="720" border="1">
                  ...
                  <tr>
                    <td height="88" colspan="4"><div align="center"><a href="../examples/VIR.php"><img src="../images/tires.gif" alt="" width="150" height="147"></a></div>                    
                  </tr>
                  <tr>
            ...
            <div class="box-body">
              <form name="form1" method="post" action="">
                <table width="311" height="584" border="1">
                  ...
                  <tr>
                    <td colspan="4"><div align="center"><a href="../examples/VIR.php"><img src="../images/tires.gif" alt="" width="150" height="147"></a></div>                    
                  </tr>
                  <tr>
                    <td height="24" colspan="4"><div align="center"> Select the Closest PSI @ Pretrip</div>                                        
                  </tr>
