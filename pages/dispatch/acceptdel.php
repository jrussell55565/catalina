        ...
        <div class="col-md-6">
          ...
          <form method="post" action="export.php">
            <table class="table table-bordered">
              ...
              <tr>
                <td>Trace Notes</td>
                <td><textarea id="remarks" name="remarks" class="form-control" placeholder="Thanks for letting dispatch know that you have accepted this Delivery."></textarea></td>
              </tr>
            </table>
            </div>
            <!-- /.box-body -->
            ...
            <div class="box-footer"> 
             <input type="submit" class="btn btn-primary" name="btn_sourceform" value="Accepted DEL"> </input>
