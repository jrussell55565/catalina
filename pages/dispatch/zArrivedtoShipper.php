...
<div id="pagewrap" class="clearfix">
        ...
        <tr>
          <td width="162">
            ...
            <td width="86" rowspan="2" hidden="hidden"><label>
              <input name="Status" type="text" id="Status" value="Arrived to Shipper" size="15" readonly/>
  ...
  <input name="Pieces" type="text" id="Pieces" value='<?php echo "$pieces";?>' size="6" />
        ...
        <tr>
          <td colspan="4"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Arrived to Shipper" /></div></td>
        </tr>
...
<input name="<?php echo constant('BX_PUDN'); ?>" type="text" id="<?php echo constant('BX_PUDN'); ?>" value="<?php echo $drivername; ?>" size="12" /></td>
	...
	<?php accessorials("PU",basename(__FILE__),$_GET['username']); ?>
                <tr>
          <td colspan="3"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Arrived to Shipper" /></td>
          </tr>
        </table>
</form>
