...
$tire_pressure_array = array(125,120,115,110,105,100,95,90,80,85,75,70,65,60,50,55,40,30,20,10);
...
<div class="alert alert-danger" role="alert" style="padding: 1px; text-align: center; display: none" id="preorpostdiv">Choose Pre/Post Trip</div>
</tr>
<tr>
...
<tr>
<td colspan="5"><div align="center">Click Here for <a href="vir_previous.php">Previous VIRS</a></div>
<div align="center"></div>
<div align="center"></div>
</tr>
</table>
...
<?php foreach($tire_pressure_array as $tp) {?>
<option <?php echo ($tp == 105 ? 'selected': null);?>><?php echo $tp; ?></option>
<?php } ?>
</select>
</p>
</div>
...
<?php foreach($tire_pressure_array as $tp) {?>
<option <?php echo ($tp == 100 ? 'selected': null);?>><?php echo $tp; ?></option>
<?php } ?>
</select>
</p>
...
<?php foreach($tire_pressure_array as $tp) {?>
<option <?php echo ($tp == 95 ? 'selected': null);?>><?php echo $tp; ?></option>
<?php } ?>
</select>
</p>
...
<tr>
  ...
  <div name="div_sprinter_tire_vir" id="div_sprinter_tire_vir" class="box box-primary collapsed-box vir sprinter">
                      ...
                      <table width="258" height="307" border="1">
                        <tr>
                          ...
                          <tr>
                            ...
                            <tr>
                              <td ><div><h4 style="text-align: center;">Photos</h4>
                                <div style="width: 98%; margin: auto;">
                                  <strong>Front</strong>
                                  <div class="input-group">
                                    <label class="input-group-btn">
                                      <span class="btn btn-primary">
                                        Browse&hellip; <input type="file" style="display: none;" name="fileToUpload[]">
                                      </span>
                                    </label>
                                ...
                                <div style="width: 98%;margin: auto;margin-bottom: 5px;">
                                  <strong>Side</strong>
                                  <div class="input-group">
                                    <label class="input-group-btn">
                                      <span class="btn btn-primary">
    ...
    // This populates the file upload input
    $(function() {
