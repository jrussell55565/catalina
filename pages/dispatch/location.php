...
<div id="map-canvas" style="height:500px; width:1000px"></div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Driver Export<span class="progress-text"></span></h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  <div class="btn-group">
                    <button class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i class="fa fa-wrench"></i></button>
               ...
               <div class="input-daterange input-group" id="datepicker" style="width: 25%;">
                ...
                <div class="input-group" style="margin-top: 5px">
                 <label class="radio-inline">
                  <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="exportDisplay"> Display
                 </label>
                 <label class="radio-inline">
                  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="exportCsv" checked> CSV
                 </label>
                </div>
                <div class="input-group" style="margin-top: 5px">
                 <input type="submit" class="btn btn-primary" name="exportDisplay" id="exportDisplay" value="Display Results"/>
                </div>
