...
<title>Trailer Dropped DEL</title>
  ...
  <section class="clearfix">
    ...
    <article class="post-6591 post type-post status-publish format-standard hentry category-articles tag-design tag-opinion tag-responsive article" id="post-6591">
        <header class="postheader">
            <div class="banner">
                <h1>Trailer Dropped DEL</h1>
                            </div>
        </header>
      
        <div class="grid-row centered">
            <form id="trailerdroppeddel" name="trailerdropeddel" method="post" action="export.php">
      <table width="350" border="1">
        <tr>
          <td width="163">
            ...
            <td width="86" rowspan="2" hidden="hidden"><label>
              <input name="Status" type="text" id="Status" value="Trailer Dropped" size="15" readonly/>
        ...
        <tr>
          <td> Pieces
  <input name="Pieces" type="text" id="Pieces" value='<?php echo "$pieces";?>' size="6" />
            <label></label>
            <td colspan="2">Pallets
              <input name="Pallets" type="text" id="Pallets" value='<?php echo "$pallets";?>' size="4" />
              <td>        </tr>
        <tr>
          <td height="0">
            Trailer
            <input name="<?php echo constant('BX_LP'); ?>" type="text" id="<?php echo constant('BX_LP'); ?>" value="<?php echo $trailer; ?>" size="6" readonly="readonly" /></td>
          <td height="0" colspan="2">Date
            <input name="<?php echo constant('BX_LD'); ?>" type="text" id="<?php echo constant('BX_LD'); ?>" value="<?php echo $localdate; ?>" size="6" readonly="readonly"/></td>
          <td height="0">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="4"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Trailer Dropped" /></div></td>
        </tr>
...
<input name="<?php echo constant('BX_PUDN'); ?>" type="text" id="<?php echo constant('BX_PUDN'); ?>" value="<?php echo $drivername; ?>" size="12" /></td>
          <td height="-2" colspan="3">DropTime:
            <input name="<?php echo constant('BX_LT'); ?>" type="text" id="<?php echo constant('BX_LT'); ?>" value="<?php echo $localtime; ?>" size="10"/></td>
        </tr>
        <tr>
		...
		<?php accessorials("DEL",basename(__FILE__),$_GET['username']); ?>
	        <tr>
          <td colspan="3"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Trailer Dropped" /></td>
          </tr>
        </table>
</form>
