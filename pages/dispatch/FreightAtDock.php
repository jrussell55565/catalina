...
<div id="pagewrap" class="clearfix">
        ...
        <tr>
          <td width="162">
            ...
            <td width="86" rowspan="2" hidden="hidden"><label>
              <input name="Status" type="text" id="Status" value="Freight At Dock" size="15" readonly/>
  ...
  <input name="Pieces" type="text" id="Pieces" value='<?php echo "$pieces";?>' size="6" />
        ...
        <tr>
          <td colspan="4"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Freight At Dock" /></div></td>
        </tr>
...
<input name="<?php echo constant('BX_PUDN'); ?>" type="text" id="<?php echo constant('BX_PUDN'); ?>" value="<?php echo $drivername; ?>" size="12" /></td>
          <td height="-2" colspan="3">ArriveTime:
	...
	<?php accessorials("PU",basename(__FILE__),$_GET['username']); ?>
                <tr>
          <td colspan="3"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Freight At Dock" /></td>
          </tr>
        </table>
</form>
