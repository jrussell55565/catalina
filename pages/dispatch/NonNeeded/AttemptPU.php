...
<div id="pagewrap" class="clearfix">
  ...
  <section class="clearfix">
    ...
    <article class="post-6591 post type-post status-publish format-standard hentry category-articles tag-design tag-opinion tag-responsive article" id="post-6591">
        ...
        <div class="grid-row centered">
            <form id="attemptpu" name="attemptedpu" method="post" action="export.php">
        ...
        <tr>
          <td width="163">
            ...
            <td width="86" rowspan="2" hidden="hidden"><label>
              <input name="Status" type="text" id="Status" value="Attempted Pick Up" size="15" readonly/>
  ...
  <input name="Pieces" type="text" id="Pieces" value='<?php echo "$pieces";?>' size="6" />
        ...
        <tr>
          <td colspan="4"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Attempted Pick Up" /></div></td>
        </tr>
...
<input name="<?php echo constant('BX_PUDN'); ?>" type="text" id="<?php echo constant('BX_PUDN'); ?>" value="<?php echo $drivername; ?>" size="12" /></td>
          <td height="-2" colspan="3">AtmptTime:
		...
		<?php accessorials("PU",basename(__FILE__),$_GET['username']); ?>
	        <tr>
          <td colspan="3"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform1" value="Attempted Pick Up" /></td>
          </tr>
        </table>
</form>
