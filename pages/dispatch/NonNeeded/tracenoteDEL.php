...
<div id="pagewrap" class="clearfix">
        ...
        <tr>
          <td width="162">
            ...
            <td width="86" rowspan="2" hidden="hidden"><label>
              <input name="Status" type="text" id="Status" value="Trace Note DEL" size="15" readonly/>
  ...
  <input name="Pieces" type="text" id="Pieces" value='<?php echo "$pieces";?>' size="6" />
        ...
        <tr>
          <td colspan="4"><div align="center"><input type="submit" name="btn_sourceform" id="btn_sourceform" value="Trace Note DEL" /></div></td>
        </tr>
