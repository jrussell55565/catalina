          ...
          <form method="post" action="export.php">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><textarea id="remarks" name="remarks" class="form-control" placeholder="Enter notes here!!"></textarea></td>
              </tr>
            </table>
            </div>
            <!-- /.box-body -->
            ...
            <div class="box-footer"> 
             <input type="submit" class="btn btn-primary" name="btn_sourceform" value="Out for Delivery"> </input>
