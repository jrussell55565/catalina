  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Delivery Confirmed</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box-body">
            <?php
             if (isset($_GET['expError']))
             {?>
               <div class="alert alert-danger" role="alert" style="padding: 1px; text-align: center">
             <?php
               echo pageErrors($_GET['expError']);
             } ?>
           </div>
          <form id="delconfirmed" method="post" action="export.php" onSubmit="return DELcheck()">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td><div class="bootstrap-timepicker">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        <input type="text" class="form-control podtimepicker" name="bx_localtime">
                        <div class="input-group-addon"> <i class="fa fa-clock-o"></i> </div>
                      </div>
                      <!-- /.input group -->
                    </div>
            ...
            <div class="box collapsed-box">
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  <?php accessorials("DEL",basename(__FILE__),$username); ?>
                </table>
              </div>
              <!-- /.box-body -->
            </div>
            <div class="box-footer">
             <input type="submit" class="btn btn-primary" name="btn_sourceform" value="Delivered"> </input>
...
<script type="text/javascript">
      $(function () {
        //Timepicker
        $(".arrivedtimepicker").timepicker({
          showInputs: false,
          showMeridian: false,
          minuteStep: 1,
          defaultTime: '<?php echo $splitArrivedTime[1];?>'
        });
        $(".podtimepicker").timepicker({
          showInputs: false,
          showMeridian: false,
          minuteStep: 1
        });
