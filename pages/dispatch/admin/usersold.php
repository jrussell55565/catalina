              ...
              <div class="box">
                ...
                <div class="box-footer">
                  <table width="826" height="343" border="1" id="Users">
                    <tr>
                      <td height="337"><p>Add New User function: Create new PHP from edituser.php / Rename newuser.php to create new user. Need to add java function to make sure all fields are proplerly filled out.</p>
<p><a href="edituser.php">Name: Arrow Down action:</a></p>
                        <p>Login As User (Icon Lock) Use current Admin Truck # and Trailer # and Odometer to quick link log Out Admin out and then relog in to selected user.</p>
                      <p><a href="edituser.php"><img src="../../../dist/img/userimages/useradminexample1.jpg" width="1366" height="768"></a></p></td>
                    </tr>
