...
<a href="/pages/dispatch/orders.php">
                ...
                <div class="info-box-content">
                  <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                        <div class="info-box-content"><span class="info-box-text"><a href="/pages/dispatch/orders.php">Combined Load Boards</a></span><span class="info-box-number"> Todays  PU: <?php echo "$pu_today_count";?><br>
                    ...
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="pages/dispatch/vir.php" class="button animated rubberBand">
                        <style>
 a.button {
	 ...
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-red"><i class="fa fa-wrench faa-wrench animated"></i></span> </a>
                        <div class="info-box-content">
                          <p><span class="info-box-text"><a href="pages/dispatch/vir.php">Combined   VIRs</a></span> <span class="info-box-number"> Todays  VIRS: <?php echo "$pu_today_count";?><br>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="pages/tables/fuel.php" class="button2 animated zoomIn">
                        <style>
 a.button2 {
	 ...
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-green"><i class="fa fa-tachometer"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="pages/dispatch/vir.php">Combined Fuel Logs</a></span><span class="info-box-number">Todays  Fuel: <?php echo "$pu_today_count";?><br>
                          Last 8 days Fuel: <?php echo "$del_today_count";?></span></div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="pages/tables/ifta.php" class="button3 animated jello">
                        <style>
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-yellow"><i class="fa fa-newspaper-o"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="pages/dispatch/vir.php">Combined  IFTA Reports</a></span><span class="info-box-number">Todays  IFTA: <?php echo "$pu_today_count";?><br>
                          Last 8 days IFTA: <?php echo "$del_today_count";?></span></div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="pages/tables/ifta.php" class="button3 animated pulse">
                        <style>
 a.button3 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-blue"><i class="fa fa-bank"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="pages/dispatch/vir.php">Combined  DOT Saftey Report</a></span> <span class="info-box-number"> Import Export Reports</span></div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
 ...
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-purple"><i class="fa fa-map-marker"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="pages/dispatch/adminusers.php">Locate Drivers</a></span><span class="info-box-number"> Import Export Locations</span></div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="pages/tables/ifta.php" class="button3 animated tada">
                        <style>
 a.button3 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-#607D8B"><i class="fa fa-check-square-o"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="pages/dispatch/adminusers.php"> Edit Accessorials</a></span><span class="info-box-number"> Import Export Reports</span></div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
                    <!-- /.col -->
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box"> <a href="/pages/dispatch/admin/users.php" class="button4 animated pulse">
                        <style>
 a.button4 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
                        ...
                        <span class="info-box-icon bg-brown"><i class="fa fa-users"></i></span> </a>
                        <div class="info-box-content"> <span class="info-box-text"><a href="/pages/dispatch/admin/users.php"> Edit Users</a></span> <span class="info-box-number">Edit All Users </span> </div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    </div>
              ...
              </div></div></div></div><div class="row"><div class="col-md-12"><div class="box"><div class="box-header with-border">
                ...
                <div class="box-footer">
                  <table width="1156" height="75" border="1" id="Users">
                    <tr>
                      <td width="76" height="23">Driver Name</td>
                      <td width="135">Login</td>
                      <td width="117">Pass</td>
                      <td>Email</td>
                      <td>AltE</td>
                      <td width="179">V Text</td>
                      <td width="75">AltV</td>
                      <td width="143">Driver ID</td>
                      <td width="46">Admin</td>
                      <td width="58">Add</td>
                      <td width="88">Delete</td>
                    </tr>
                    <?php
		...
		?>
                    <form id="usermanagement_add" name="usermanagement_add" method="post" action="../useractions.php">
                      <tr>
                        ...
                        <td width="31"><input type="checkbox" name="ck_emailupdate" id="ck_emailupdate" /></td>
                        <td><label>
