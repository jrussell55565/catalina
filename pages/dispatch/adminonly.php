      ...
      <div class="content-wrapper"> 
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Admin Only</li>
          </ol>
        </section>
        
        <!-- Animated Top Menu Insert PHP Reference to /wwwlive/dist/menus_sidebars_elements  -->
        
        <?php require($_SERVER['DOCUMENT_ROOT'].'/dist/menus_sidebars_elements/topmenuanimationblank.php');?>
          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title"> You Do Not Have Access to this Page </h3>
            ...
            <form class="form" method="get" action="">
              <div class="box-body">
                <div class="input-group" style="margin-top: 5px"></div>
                <div class="input-group" style="margin-top: 5px"></div>
              </div>
              </div>
              </form>
...
<section class="content">
          ...
          <div class="error-page">
            <h2 class="headline text-yellow"> 500 Server Error Admin Access Only</h2>
            <div class="error-page">
              <h3><i class="fa fa-warning text-yellow"></i> Oops! Page not found.</h3>
              <p>
                We could not find the page you were looking for.
                You may <a href='/pages/main/index.php'>return to dashboard</a>.
              </p>
