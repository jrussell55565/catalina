...
<?php require($_SERVER[DOCUMENT_ROOT].'/dist/menus_sidebars_elements/sidebar.php');?>
    ...
    <div class="content-wrapper"> 
      ...
      <section class="content-header">
        <h1> CSA Violations</h1>
        <ol class="breadcrumb">
          <li><a href="orders.php"><i class="fa fa-home"></i> Home</a></li>
          <li class="active">CSA Violations</li>
        </ol>
      </section>
        ...
        <div class="col-md-8">
          <div class="box">
            <div class="box-header with-border">
              <h1>What?</h1>
              To Download the Excell File <a href="kingpin.jpg">click here</a>: <br>
              <br>
              <div>
                <div>
                  <div><br>
                    <div><br>
                      ...
                      <table width="901" border="1">
                        <tr>
                          <td colspan="7">Unsafe Driving CSA Violations</td>
                        </tr>
                        <tr>
                          <td width="99">Category</td>
                          <td width="93">Section</td>
                          <td width="75">Description</td>
                          <td width="123">Violation Group</td>
                          <td width="94">Severity</td>
                          <td width="276">&nbsp;</td>
                          <td width="95">&nbsp;</td>
                        </tr>
                      </table>
