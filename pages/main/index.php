...
if (isset($_POST['broadcast_message']))
{
  ...
  $sql .= " FROM users WHERE 1=1 $predicate AND status='Active'
           AND curtime() <= str_to_date(quiet_time_begin,'%H:%i') and curtime() >= str_to_date(quiet_time_end, '%H:%i')";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">      
        ...
        <div class="modal-footer"  style="text-align:left;">
          <span class="pull-left"><h4>Click on the button to read your tasks.</h4>      
