...
<span class="info-box-text"><a href="/pages/dispatch/orders.php"> My Load Board</a></span><span class="info-box-number">  Todays  PU:  <?php echo "$pu_today_count";?><br>
...
<style>
 a.button {
	 ...
	 -webkit-animation-iteration-count: infinite;
                ...
                <div class="info-box-content">
                  <p><span class="info-box-text"><a href="/pages/dispatch/vir.php">My VIRs</a></span>
...
<style>
 a.button2 {
	 ...
	 -webkit-animation-iteration-count: infinite;
                ...
                <div class="info-box-content">
                <span class="info-box-text"><a href="pages/dispatch/fuel.php">Company Stats</a></span><span class="info-box-number">Todays  Fuel: <?php echo "$pu_today_count";?><br>
 ...
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-yellow"><i class="fa fa-newspaper-o"></i></span>
                ...
                <div class="info-box-content">
                <span class="info-box-text"><a href="pages/dispatch/ifta.php"> My IFTA/Fuel Reports</a></span><span class="info-box-number">Todays  IFTA: <?php echo "$pu_today_count";?><br>
Last 8 days IFTA: <?php echo "$del_today_count";?></span></div><!-- /.info-box-content -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
<a href="pages/tables/ifta.php" class="button3 animated pulse">
<style>
 a.button3 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-blue"><i class="fa fa-bank"></i></span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><a href="pages/dispatch/dotsafety.php"> My DOT Safety Report</a></span>
...
<style>
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
<a href="/pages/dispatch/userstats.php" class="button3 animated tada">
<style>
 a.button3 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-#607D8B"><i class="fa fa-check-square-o"></i></span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><a href="/pages/dispatch/userstats.php">  My Stats</a></span><span class="info-box-number">                   View your  Stats</span></div>
                <!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->            
...
<div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
<a href="/pages/dispatch/userprofile.php" class="button4 animated pulse">
<style>
 a.button4 {
	 -webkit-animation-duration: 3s;
	 -webkit-animation-delay: 1s;
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-brown"><i class="fa fa-users"></i></span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><a href="/pages/dispatch/userprofile.php"> My Profile &amp; Messages</a></span>
