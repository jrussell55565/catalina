...
<span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/orders.php"> My Load Board</a></span><span class="info-box-number">  Todays  PU:  <?php echo "$pu_today_count";?><br>
...
<style>
 a.button {
	 ...
	 -webkit-animation-iteration-count: infinite;
                ...
                <div class="info-box-content">
                  <p><span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/vir.php">My VIRs</a></span>
...
<style>
 a.button2 {
	 ...
	 -webkit-animation-iteration-count: infinite;
                ...
                <div class="info-box-content">
                <span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/fuel.php">Company Stats</a></span><span class="info-box-number">Todays  Fuel: <?php echo "$pu_today_count";?><br>
 ...
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-yellow"><i class="fa fa-newspaper-o"></i></span>
                ...
                <div class="info-box-content">
                <span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/ifta.php"> My IFTA/Fuel Reports</a></span><span class="info-box-number">Todays  IFTA: <?php echo "$pu_today_count";?><br>
 ...
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-blue"><i class="fa fa-bank"></i></span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/admin/csa.php"> My DOT Safety Report</a></span>
 ...
 a.button3 {
	 ...
	 -webkit-animation-iteration-count: infinite;
               ...
               <span class="info-box-icon bg-#607D8B"><i class="fa fa-check-square-o"></i></span>
                ...
                <div class="info-box-content">
                  <span class="info-box-text"><a href="<?php echo HTTP;?>/pages/dispatch/userstats.php">  My Stats</a></span><span class="info-box-number">                   View your  Stats</span></div>
                <!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->            
