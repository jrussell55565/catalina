          <ul class="sidebar-menu">
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="orders.php"><i class="fa fa-circle-o"></i> Shipment Boards</a></li>
                <li class="active"><a href="http://dispatch.catalinacartage.com/orders.php"><i class="fa fa-circle-o"></i> Old Shipment Boards</a></li>
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Vehicle Inspections</a></li>
