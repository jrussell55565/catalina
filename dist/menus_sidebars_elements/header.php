  <header class="main-header">
    <!-- Logo -->
    <a href="http://dispatch.catalinacartage.com/adminlte/index.php" class="logo">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                    <div class="pull-left"> <img src="<?php echo HTTP;?>/dist/img/user1-128x128.jpg" class="img-circle" alt="User Image"/> </div>
                  ...
                  <li> <a href="#">
                    <div class="pull-left"> <img src="<?php echo HTTP;?>/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/> </div>
          ...
          <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php echo HTTP;?>/dist/img/usernophoto.jpg" class="user-image" alt="User Image"/> <span class="hidden-xs"><?php echo "$drivername"; ?></span> </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left"> <a href="/pages/dispatch/userprofile.php" class="btn btn-default btn-flat">Profile</a> </div>
                <div class="pull-right"> <a href="/pages/login/logout.php" class="btn btn-default btn-flat">Sign out</a> </div>
              </li>
            </ul>
          </li>
