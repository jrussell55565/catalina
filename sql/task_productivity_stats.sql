CREATE PROCEDURE `task_productivity_stats`(IN v_date_start VARCHAR(20), v_date_end VARCHAR(20), v_print BOOLEAN)
  BEGIN
    ...
    INSERT INTO task_productivity_tmp (
      SELECT
        and_last_one.days_worked,
        and_last_one.miles,
        and_last_one.idle_time,
        and_last_one.passed_quizzes,
        and_last_one.all_quizzes,
        and_last_one.tasks_completed_by_user,
        and_last_one.tasks_all_user,
        and_last_one.category,
        and_last_one.days_shoulda_worked,
        and_last_one.idle_from_hrs,
        and_last_one.idle_to_hrs,
        and_last_one.idle_points,
        and_last_one.est_per_gallon,
        and_last_one.aprox_used_gallons,
        and_last_one.aprox_idle_costs,
        and_last_one.days_worked_points,
        and_last_one.miles_points,
        and_last_one.task_points,
        and_last_one.quiz_points,
        and_last_one.idle_time_points,
        and_last_one.activity_total_points,
        and_last_one.activity_max_points,
        coalesce(round((and_last_one.activity_total_points / and_last_one.activity_max_points) * 100, 0), 0) AS total_percent,
